...
AS $$
DECLARE
  project_url TEXT := 'https://crwnurudkrewtriekhqj.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNyd251cnVka3Jld3RyaWVraHFqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA2OTIxMTEsImV4cCI6MjA2NjI2ODExMX0.uojhOZkL_USyQy14UTjByyibX5qGlxoRAaerPjRa0Yo'; -- full access needed for http request to storage
